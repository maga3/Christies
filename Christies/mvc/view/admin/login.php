            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action="../../index.php/admin/login/process" class="pt-3" method="post">
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" name="usr" placeholder="Username" required>
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg mb-1" id="exampleInputPassword1" name="pass" placeholder="Password" required>
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <a href="../../index.php/admin/recuperar" class="auth-link text-black">Forgot password?</a>
                </div>
